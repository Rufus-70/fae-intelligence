    ...
    <div className="min-h-screen">
      ...
      <section className="bg-primary text-primary-foreground py-10 md:py-12">
        <Container className="text-center !py-0">
            ...
            <p className="text-lg sm:text-xl font-semibold text-primary-foreground/90 mb-1 normal-case">
                Practical AI, Real-World Results Across Your Organization
            </p>
            <p className="text-md sm:text-lg text-primary-foreground/80 normal-case">
      ...
      <section className="bg-background text-foreground py-10 md:py-12">
        <Container className="max-w-4xl mx-auto space-y-6">
            <div className="mb-6 md:float-right md:ml-6 md:mb-2 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 relative">
              <Image
            ...
            <p className="text-lg text-foreground/90 normal-case leading-relaxed">
            For over 30 years, I lived and breathed operastions. I saw the incredible potential within teams and processes, but I also saw the frustrating reality that impacted <em>every</em> department: constant <strong>resource constraints</strong>, essential knowledge workers that never have time, and critical support always stretched too thin. I knew there were better ways &ndash; overlooked efficiencies and <strong>untapped potential</strong> across the entire organization.
            </p>
        </Container>
      </section>
      ...
      <section className="bg-primary text-primary-foreground py-10 md:py-12">
        <Container className="max-w-4xl mx-auto space-y-6">
          <div className="flex items-center gap-3">
            ...
            <p className="text-lg normal-case text-primary-foreground/90 leading-relaxed">
      ...
      <section className="bg-background text-foreground py-10 md:py-12">
        <Container className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-lg normal-case text-foreground/90 leading-relaxed">
            ...
            <blockquote className="my-4 p-4 border-l-4 border-accent bg-muted/50 text-foreground/90 italic rounded-md text-lg shadow relative leading-relaxed">
              <QuoteIcon className="absolute top-2 left-2 w-6 h-6 text-accent/50 transform -translate-x-1/2 -translate-y-1/2" />
              &quot;Any sufficiently advanced technology is indistinguishable from magic.&quot;
              <cite className="block text-right text-sm not-italic text-muted-foreground mt-2">- Arthur C. Clarke</cite>
            </blockquote>
            <p className="text-lg normal-case text-foreground/90 leading-relaxed">
      ...
      <section className="bg-background text-foreground py-10 md:py-12">
        <Container className="max-w-4xl mx-auto">
          <Card className="bg-card border-border shadow-lg text-card-foreground">
            <CardHeader>
              <div className="flex items-center gap-3">
            ...
            <CardContent className="space-y-4 text-lg normal-case text-foreground/90 leading-relaxed">
              <p>
      ...
      <section className="bg-primary text-primary-foreground py-10 md:py-12">
        <Container className="text-center max-w-3xl mx-auto !py-0">
          <p className="text-xl font-semibold text-accent normal-case">
        ...
        <Container className="text-center max-w-3xl mx-auto space-y-6 !pt-6 !pb-8">
            <div className="max-w-4xl mx-auto space-y-6 text-left"> {/* Adjusted for quote block */}
              ...
              <blockquote className="my-4 p-4 border-l-4 border-accent bg-muted/50 text-foreground/90 italic rounded-md text-lg shadow relative leading-relaxed">
                ...
                <cite className="block text-right text-sm not-italic text-muted-foreground mt-2">- W. Edwards Deming</cite>
              </blockquote>
              <p className="text-lg text-foreground/90 normal-case leading-relaxed">
            ...
            <p className="text-lg text-foreground/80 max-w-xl mx-auto normal-case leading-relaxed">
              Welcome to Fae Intelligence. Let's unlock the hidden potential across your organization, starting today.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-4">
              <Button asChild size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground shadow-md px-8 py-3">
                <Link href="/contact">
                  Contact Us Today <ExternalLink className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="border-accent text-accent hover:bg-accent hover:text-accent-foreground shadow-md px-8 py-3">
                <Link href="/services">
