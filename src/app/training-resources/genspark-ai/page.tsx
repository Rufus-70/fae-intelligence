...
import { ArrowLeft, Cpu } from 'lucide-react'; // Changed ArrowRight to ArrowLeft
      ...
      <main className="flex-grow container mx-auto px-4 md:px-6 py-12 md:py-16 bg-background">
        ...
        <div className="bg-card text-foreground shadow-xl rounded-lg p-6 md:p-10">
          <div className="text-center py-12">
            ...
            <h2 className="text-3xl font-semibold font-headline text-primary mb-4">GensparK AI Overview</h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
              This page is a placeholder for the GensparK AI Training Guide. Content is currently under development and will be available soon.
            </p>
            <div className="mt-10">
