      ...
      <main>
        <Container className="py-10 md:py-12">
            ...
            <section id="firestore-fundamentals">
                <SectionTitle id="firestore-title">Firestore Fundamentals</SectionTitle>
                ...
                <SubSectionTitle id="firestore-data-modeling">Data Modeling in Firestore</SubSectionTitle>
  ...
  settings: {
    ...
    notifications: true
            ...
            <section id="integration">
                ...
                <SubSectionTitle id="integration-typescript">TypeScript Integration (Web/Node.js)</SubSectionTitle>
...
async function addUser(name: string, email: string) {
  try {
    ...
    console.error("Error adding document: ", e);
                ...
                <SubSectionTitle id="integration-realtime-ts">Real-time Updates in TypeScript</SubSectionTitle>
...
// unsubscribe();
                ...
                <SubSectionTitle id="integration-python">Python Integration (Server-side)</SubSectionTitle>
