    ...
    <footer className="border-t border-border/50 bg-background">
      <div className="container mx-auto px-4 md:px-6 py-8 md:py-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          ...
          <div className="text-sm text-muted-foreground text-left md:text-right space-y-2">
            ...
            <div className="mt-4 pt-2 border-t border-border/30 md:border-t-0 md:pt-0 md:mt-2 flex items-center justify-start md:justify-end space-x-4">
